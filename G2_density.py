...
G = nx.Graph(np.load(f"./Data/G2.npy"))
c = 0.4 # fugacity
k = 80
iteration = 1000
mixing_time = 1000
...
np.save(f"./Data/G2/RS_density_list.npy", max_density_list)
...
np.save(f"./Data/G2/glauber_RS_density_list.npy", glauber_max_density_list)
...
np.save(f"./Data/G2/jerrum_glauber_RS_density_list.npy", jerrum_glauber_max_density_list)
...
np.save(f"./Data/G2/SA_density_list.npy", max_density_list)
...
np.save(f"./Data/G2/glauber_SA_density_list.npy", glauber_max_density_list)
...
np.save(f"./Data/G2/jerrum_glauber_SA_density_list.npy", jerrum_glauber_max_density_list)