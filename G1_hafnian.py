...
# Finding the 80-node subgraph with the maximum hafnian using Random Search
...
# Finding the 80-node subgraph with the maximum hafnian using Simulated Annealing
max_hafnian_list = np.zeros((10, iteration+1))
for i in tqdm(range(10)):
